    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.author')),
            ],
        ),
        migrations.CreateModel(
            name='Journal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.region')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_ranking', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.rankings')),
                ('id_university', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.university')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_doc', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.document')),
                ('id_university', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.university')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_doc', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.document')),
                ('id_sub', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.subject')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_auth', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.author')),
                ('id_doc', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.document')),
                ('id_university', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.university')),
            ],
        ),
        migrations.AddField(
            model_name='document',
            name='issn',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.journal'),
        ),
        migrations.CreateModel(
            name='AuthorUniversity',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_auth', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.author')),
                ('id_university', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.university')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.author')),
                ('id_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.subject')),
            ],
        ),
        migrations.CreateModel(
            name='AuthorJournal',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_auth', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.author')),
                ('id_journal', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.journal')),
            ],
        ),
        migrations.AddField(
            model_name='author',
            name='affilation_current',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filtering_posts.university'),
        ),
    ]
